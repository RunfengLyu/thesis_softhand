...
from softhand_sim.utils import helpers as utl
from softhand_sim.policies.rl.sac import SAC
from softhand_sim.policies.rl.td3 import TD3
import softhand_sim.torchkit.pytorch_utils as ptu
from softhand_sim.policies.models.recurrent_critic import Critic_RNN
from softhand_sim.policies.models.recurrent_actor import Actor_RNN
from softhand_sim.utils import logger
...
class ModelFreeOffPolicy_Separate_RNN(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.algo = TD3(**kwargs, action_dim=action_dim)
